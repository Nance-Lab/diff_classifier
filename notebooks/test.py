...
imp = IJ.openImage('/home/ubuntu/source/diff-classifier/notebooks/FakeTracks.tif')
IJ.run(imp, "Properties...", "channels=1 slices=1 frames=50 unit=pixel pixel_width=1.0000 pixel_height=1.0000 voxel_depth=1.0000");
...
settings.detectorSettings = {
    ...
    DetectorKeys.KEY_RADIUS : 3.5,
    DetectorKeys.KEY_TARGET_CHANNEL : 1,
    DetectorKeys.KEY_THRESHOLD : 0.0,
...
filter7 = FeatureFilter('TRACK_DURATION', 5.0, True)
